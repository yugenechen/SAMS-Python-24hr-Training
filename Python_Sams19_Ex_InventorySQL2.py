...
#       [Status]: Done,
                  ...
                  ptr.execute("ALTER TABLE Inventory 
...
def addTableField(dbName, tableName, newColumn, newColDataType, path=""):
    ...
    ptr = conn.cursor()
    ptr.execute("PRAGMA table_info(tableName);")
    ...
    if not fieldAlreadyExists:
        sqlNewField = ("ALTER TABLE Inventory ADD COLUMN Desc text")
        sql = ("ALTER TABLE Inventory ADD COLUMN Description text;")
