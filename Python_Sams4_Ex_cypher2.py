    ...
    if (x_value > -1):
        ...
        #character is A-Z
            ...
            if chr_input == "M":
                print "M = " , x_value
                print x_value%ROT13
                print ROT13*abs(x_value/ROT13-1)
...
print "\nYTC-CYPHERED MSG________:  \n" + cyphered_msg + "\n"
print "DeCyphered using ROT-13-Python:  \n"+ ("".join([this.d.get(c, c) for c in cyphered_msg])) + "\n"
# ROT-13-Python cypher:  this.d = the stored Cypher table, gets each character in my text and replaces it with the cyphermap
print "Encrypted with ROT-13-Python-Cyphered__\n:  " + ("".join([this.d.get(c, c) for c in myText]))
